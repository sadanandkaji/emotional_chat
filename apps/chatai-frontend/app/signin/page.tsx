...
export default function signin(){
    return<div className="w-screen h-screen flex justify-center items-center" >
        ...
        <div >
            <div className=" flex justify-center pt-8 pb-3"><Inputelement variant="primary"className="bg-gray-800 shadow-xl" placeholder="email" type="text" size="sm" ></Inputelement> </div>
           <div  className="flex justify-center "><Inputelement className="bg-gray-800 shadow-xl" variant="primary" type="password" placeholder="password"  size="sm"></Inputelement></div>
            ...
            <Button variant="send" children={"signin"} className="bg-blue-600 text-lg text-black px-8 py-2  border border-gray-600 shadow-2xl" size="sm"></Button>
            </div>
